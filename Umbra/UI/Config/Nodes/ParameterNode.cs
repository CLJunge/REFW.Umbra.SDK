...
/// Number of spacing calls emitted before the draw action when the parameter is visible.
...
/// Number of spacing calls emitted after the draw action when the parameter is visible.
