...
internal interface IUndoShortcutInputSource
{
    ...
    /// <summary>
    /// Returns a value indicating whether the built-in default redo shortcut was pressed during the current frame.
    /// </summary>
    /// <returns><see langword="true"/> when the default redo shortcut was pressed; otherwise, <see langword="false"/>.</returns>
    bool IsDefaultRedoShortcutPressed();
