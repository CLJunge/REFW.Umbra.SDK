...
/// </summary>
/// <remarks>
/// This non-generic contract exists so transfer-capable UI surfaces can work with a loaded config
/// store without requiring the UI type itself to carry the store's generic constraints.
/// </remarks>
public interface IConfigTransferStore
{
    /// <summary>
    /// Gets the configured main config file path for the store.
    /// </summary>
    string FilePath { get; }
    ...
    /// <summary>
    /// Imports compatible values from a config exchange document or legacy flat config file.
    /// </summary>
