...
/// </summary>
/// <remarks>
/// <see cref="ConfigPersistence"/> uses this helper while loading a settings file. Values are applied through <see cref="IParameter.SetValueWithoutNotify(object?)"/> so persisted-state restoration does not trigger change notifications.
/// </remarks>
