...
/// <summary>
/// Provides list helpers used by Umbra components that need stable in-place ordering without LINQ.
/// </summary>
internal static class ListExtensions
{
    ...
    /// <summary>
    /// Sorts <paramref name="list"/> in place by the ascending integer key returned from <paramref name="keySelector"/> while preserving the original order of equal keys.
    /// </summary>
    /// <remarks>
    /// The implementation uses a stable insertion sort for small lists and switches to a stable merge sort for larger lists to reduce worst-case cost.
    /// </remarks>
    /// <typeparam name="T">The element type stored in the list.</typeparam>
    /// <param name="list">The list to sort in place.</param>
    /// <param name="keySelector">The callback that returns the integer sort key for each element.</param>
