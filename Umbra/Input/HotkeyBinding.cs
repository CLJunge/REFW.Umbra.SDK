...
/// </summary>
/// <param name="Key">The primary <see cref="ImGuiKey"/> value cast to <see cref="int"/>. Use <c>(int)ImGuiKey.None</c> for an unbound hotkey.</param>
...
public readonly record struct HotkeyBinding(int Key, bool Ctrl, bool Shift, bool Alt)
{
    ...
    /// </summary>
    public static readonly HotkeyBinding None = new((int)ImGuiKey.None, false, false, false);

    /// <summary>
    /// Gets a value indicating whether this binding has no primary key assigned.
    /// </summary>
    public bool IsEmpty => Key == (int)ImGuiKey.None;
