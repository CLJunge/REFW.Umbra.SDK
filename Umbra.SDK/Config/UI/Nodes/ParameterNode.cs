...
/// Absorbed from <see cref="Umbra.SDK.Config.Attributes.SpacingBeforeAttribute"/> during the build pass. Defaults to <c>0</c>.
/// </param>
/// <param name="spacingAfter">
/// Number of <c>ImGui.Spacing()</c> calls emitted after the draw action when the parameter is visible.
/// Absorbed from <see cref="Umbra.SDK.Config.Attributes.SpacingAfterAttribute"/> during the build pass. Defaults to <c>0</c>.
/// </param>
