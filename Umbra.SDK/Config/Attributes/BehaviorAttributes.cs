...
/// is emitted by the factory. <c>[Category]</c>, <c>[CollapseAsTree]</c>, <c>[SpacingBefore]</c>,
/// <c>[SpacingAfter]</c>, and <c>[HideIf]</c> on the property declaration are still honoured.
/// </para>
/// </remarks>
/// <typeparam name="TDrawer">
