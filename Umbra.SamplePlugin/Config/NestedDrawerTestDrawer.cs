...
internal class NestedDrawerTestDrawer : INestedGroupDrawer<NestedDrawerTest>
{
    public void Draw(NestedDrawerTest groupInstance)
    {
        ...
        ImGui.Separator();
        ImGui.Text($"Value1: {groupInstance.Value1.Value}");
        ImGui.Separator();
        ImGui.Text($"Value2: {groupInstance.Value2.Value}");
        ImGui.Separator();
        ImGui.Text($"Value3: {groupInstance.Value3.Value}");
        ImGui.Separator();
        ImGui.Text($"Value4: {groupInstance.Value4.Value}");
        ImGui.Separator();
